...
public class MailTest {
	...
	public void mailTest() {
		String mailTo = "ruwn3129@naver.com, orbital0m0@gmail.com";
		MimeMessagePreparator preparator = new MimeMessagePreparator() {

			@Override
			public void prepare(MimeMessage mimeMessage) throws Exception {
				MimeMessageHelper messageHelper = new MimeMessageHelper(mimeMessage, true, "UTF-8");
				messageHelper.setFrom(new InternetAddress("lu6way@gmail.com","LUBWAY", "UTF-8")); // 보내는 사람
				...
				messageHelper.setReplyTo(new InternetAddress("lu6way@gmail.com","replyTo", "UTF-8")); // 답장받을 주소
			}
		};
