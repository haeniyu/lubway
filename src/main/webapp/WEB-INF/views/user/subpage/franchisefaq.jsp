			...
			<div class="faq_wrapper">
				<ul class="faq_contet" id="ui_faq_items">
					<li>
						<div class="fre">
							<div class="q">Q</div>
							<strong>써브웨이 가맹점 오픈에 필요한 투자 금액은 어느 정도 인가요?</strong>
						</div>
						<div class="ask">
							<div class="a">A</div>
							<div class="ask_text">최소 전용 면적 25평 기준, 약 2억원 ~ 2억 1천만원이
								예상됩니다. (추가공사, 별도비용, 임대료, 부가세 제외) 자세한 예상비용은 홈페이지 "가맹점 → 써브웨이
					...
					<li>
						<div class="fre">
							<div class="q">Q</div>
							<strong>써브웨이 가맹점주가 되기 위한 조건이 있나요?</strong>
						</div>
						<div class="ask">
							<div class="a">A</div>
							<div class="ask_text">써브웨이는 50년이 넘는 역사를 지닌 프랜차이즈이며, 전 세계 가장 많은 매장을 운영하는 글로벌 QSR 브랜드 입니다.
...
각 지사의 가맹 개발자는 계약 체결 전, 심도 깊은 상담, 성향 테스트를 통해 이부분은 검증합니다.</div>
					...
					<li>
						...
						<div class="ask">
							<div class="a">A</div>
							<div class="ask_text">써브웨이는 각 지역권에 대해 미국 본사로 부터 승인을 받은 지사가 직접 가맹사업을 진행하고 있습니다.
