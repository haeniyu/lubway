		...
		<div class="content">
			...
			<div class="util_menu">
				<ul>
					...
					<li><a href="/login.sdo" target="_blank">점주관리자</a></li>
				</ul>
			</div>
			<!--// util menu -->
			...
			<p class="copyright">LUBWAY® is a Registered Trademark of Lubway
				IP LLC. © 2021 Lubway IP LLC. All Rights Reserved.</p>
