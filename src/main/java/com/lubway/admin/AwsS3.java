...
public class AwsS3 {
	...
	final private String accessKey = "AKIASTNHT5WFDZLIWUFT"; // IAM 에서 만든 액세스 키
	final private String secretKey = "FzI2/7Jp+x4kUQwV7IIsLhanBSogKO6PLHyoaB3f"; // IAM 에서 받은 시크릿 키 ( 분실시 액세스키 재발급 받아야합니다. )
	private Regions clientRegion = Regions.AP_NORTHEAST_2;
	private String bucket = "lubway"; // 버킷 명
